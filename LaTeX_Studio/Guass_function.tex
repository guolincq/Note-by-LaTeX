		...
		\node[scale=0.7] at (-6,3)
		{
			\begin{tikzpicture}
				...
				\begin{axis}[every axis plot post/.append style={
					...
					%\node[scale=0.7] at ($(\ymin,0)!0.5!(\ymin,0)$) {$+2\sigma$};
					
				\end{axis}
			\end{tikzpicture}
		};
		
		\node[scale=0.7] at (0,3)
		{
			\begin{tikzpicture}
